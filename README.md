...
| Configure initializer defaults, styling hooks, and field-level override precedence | [`doc/configuration.md`](doc/configuration.md) | [`doc/configuration_profiles.md`](doc/configuration_profiles.md) for copyable profile examples, [`doc/default_allow_clear.md`](doc/default_allow_clear.md) for the app-wide clear-button default, and [`doc/styling_boundary.md`](doc/styling_boundary.md) for wrapper classes and host-app CSS ownership |
