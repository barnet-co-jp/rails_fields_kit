...
- Native wrapper helpers now cover range, password, file, checkbox, and browser-native date/time/datetime-local/color inputs while keeping browser behavior, upload workflows, checkbox group semantics, timezone conversion, validation UI, and production CSS in the host application.
