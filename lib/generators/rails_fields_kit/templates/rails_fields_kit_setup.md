...
- [ ] If this app uses Vite or another bundler, add resolver or alias entries for `rails_fields_kit`, `rails_fields_kit/tom_select_controller`, and any direct helper subpaths this app intentionally imports, such as `rails_fields_kit/read_rendered_error_surface` or `rails_fields_kit/tom_select_plugin_contract`.
