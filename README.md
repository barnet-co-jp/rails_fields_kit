...
After generator setup, `rails rails_fields_kit:doctor` can inspect the host app's setup visibility without changing files. It reports initializer and importmap pin presence, can surface a representative Stimulus registration advisory signal, and leaves Tom Select package install, final Stimulus boot policy, CSS import, and bundler alias confirmation as manual host-app checks. See [`doc/setup.md`](doc/setup.md) for the maintained doctor boundary.
...
| Choose a helper or migrate from `collection_select` | [`doc/field_helpers.md`](doc/field_helpers.md) | [`doc/select_migration.md`](doc/select_migration.md), [`doc/grouped_select.md`](doc/grouped_select.md), [`doc/enum_select.md`](doc/enum_select.md), [`doc/textarea_autosize.md`](doc/textarea_autosize.md), [`doc/range_field.md`](doc/range_field.md), [`doc/password_field.md`](doc/password_field.md), [`doc/check_box.md`](doc/check_box.md), [`doc/file_field.md`](doc/file_field.md), [`doc/native_numeric_fields.md`](doc/native_numeric_fields.md), [`doc/native_contact_fields.md`](doc/native_contact_fields.md), and [`doc/native_date_time_color_fields.md`](doc/native_date_time_color_fields.md) for focused helper boundaries; use [`doc/collection_group_helpers.md`](doc/collection_group_helpers.md) when deciding whether collection checkbox / radio groups are current API; use [`doc/masked_input_boundary.md`](doc/masked_input_boundary.md), [`doc/slug_helper_boundary.md`](doc/slug_helper_boundary.md), [`doc/datalist_boundary.md`](doc/datalist_boundary.md), or [`doc/mention_field_boundary.md`](doc/mention_field_boundary.md) only when comparing nearby current helpers with future proposal boundaries |
...
| Understand shared token, Ransack, and table metadata boundaries | [`doc/shared_metadata_navigation.md`](doc/shared_metadata_navigation.md) | [`doc/table_adapters.md`](doc/table_adapters.md) for the metadata protocol, [`doc/table_direct_helper_boundary.md`](doc/table_direct_helper_boundary.md) for the direct FormBuilder helper columns-only boundary, and [`doc/table_group_html.md`](doc/table_group_html.md) when table metadata rendering is in scope |
...
| Configure initializer defaults, styling hooks, and field-level override precedence | [`doc/configuration.md`](doc/configuration.md) | [`doc/configuration_profiles.md`](doc/configuration_profiles.md) for docs-only copyable profile examples, and [`doc/styling_boundary.md`](doc/styling_boundary.md) for wrapper classes and host-app CSS ownership |
...
| Prepare or verify a release | [`doc/release.md`](doc/release.md) | Use its pre-release checklist for sample-app, final release, selected preload, package-root helper, and other evidence lanes; use [`doc/package_root_helper_release_evidence.md`](doc/package_root_helper_release_evidence.md) when the release review needs a representative helper-evidence lane; use [`doc/token_table_sample_app_evidence.md`](doc/token_table_sample_app_evidence.md) when token search, token suggestions, Ransack suggestion metadata, or table metadata sample-app evidence is in scope; keep [`doc/textarea_autosize_release_evidence.md`](doc/textarea_autosize_release_evidence.md) as the focused autosize release evidence route |
...
- Use the native wrapper helpers such as `rfk_text_field`, `rfk_text_area`, `rfk_password_field`, `rfk_check_box`, `rfk_file_field`, `rfk_money_field`, `rfk_phone_field`, `rfk_search_field`, `rfk_range_field`, `rfk_date_field`, `rfk_time_field`, `rfk_datetime_local_field`, and `rfk_color_field` when a native browser input is enough and you only want consistent labels, hints, validation errors, prefixes, suffixes, and accessibility wiring. Use [`doc/check_box.md`](doc/check_box.md) for Rails checkbox contract boundaries, [`doc/file_field.md`](doc/file_field.md) for file-input upload ownership boundaries, [`doc/range_field.md`](doc/range_field.md) for range-specific boundaries, [`doc/password_field.md`](doc/password_field.md) for password-specific non-goals, [`doc/native_numeric_fields.md`](doc/native_numeric_fields.md) for numeric formatting boundaries, [`doc/native_contact_fields.md`](doc/native_contact_fields.md) for contact/search ownership boundaries, and [`doc/native_date_time_color_fields.md`](doc/native_date_time_color_fields.md) for browser-native date/time/datetime-local/color boundaries.
...
This keeps the table gem or host app responsible for collecting column definitions, executing queries, and saving preferences. Rails Fields Kit only turns the documented metadata into FormBuilder helper calls. For the full protocol, renderer call specs, and custom renderer registry boundary, see [`doc/table_adapters.md`](doc/table_adapters.md). For the columns-only direct helper boundary and lower-level render/call-spec lanes, see [`doc/table_direct_helper_boundary.md`](doc/table_direct_helper_boundary.md). For optional group-level wrapper attributes on the direct FormBuilder helpers, see [`doc/table_group_html.md`](doc/table_group_html.md).
