...
RSpec.describe "generated setup note docs" do
  ...
  it "keeps the generated setup note pointed at the maintained walkthrough and public references" do
    expect(generated_setup_note).to include(
      ...
      "Use these upstream docs after the first pass when you need maintained examples, public API details, release checks, or troubleshooting.",
      "This generated note should link back to source-of-truth docs rather than mirror their details.",
