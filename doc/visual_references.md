...
- For design review, use the relevant static HTML file directly and keep comments tied to the lane it represents.
...
- If a new visual reference is added, update this map and the README docs map after the reference lands on `main`.
