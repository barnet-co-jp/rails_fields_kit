...
| A native browser input with shared wrapper, hint, error, affix, and accessibility behavior | Native wrapper family. Start with `rfk_text_field`, `rfk_text_area`, or `rfk_search_field`; use `rfk_password_field`, `rfk_check_box`, `rfk_range_field`, `rfk_file_field`, or the matching native helper such as `rfk_email_field`, `rfk_date_field`, `rfk_time_field`, `rfk_datetime_local_field`, or `rfk_color_field` when that focused boundary matches. | Stays in the ordinary HTML input flow while reusing Rails Fields Kit wrapper conventions. Use [`doc/public_api.md`](public_api.md) for the current helper inventory, [`password_field.md`](password_field.md) for password-specific non-goals, [`check_box.md`](check_box.md) for Rails checkbox contract boundaries, [`range_field.md`](range_field.md) for browser-native slider boundaries, [`file_field.md`](file_field.md) for file-upload ownership boundaries, [`native_numeric_fields.md`](native_numeric_fields.md) for numeric formatting non-goals, [`native_contact_fields.md`](native_contact_fields.md) for contact/search ownership boundaries, and [`native_date_time_color_fields.md`](native_date_time_color_fields.md) for browser-native date/time/datetime-local/color boundaries. |
