...
- `doc/tom_select_visual_reference.html` and `doc/tom_select_text_override_visual_reference.html`: static visual references for representative Tom Select-backed states and configured text override copy states
