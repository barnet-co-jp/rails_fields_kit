...
| Choose a helper or migrate from `collection_select` | [`doc/field_helpers.md`](doc/field_helpers.md) | Use the quick chooser and focused helper links in [`doc/field_helpers.md`](doc/field_helpers.md); keep proposal-only boundaries in `doc/*_boundary.md` until they become current public API |
...
| Prepare or verify a release | [`doc/release.md`](doc/release.md) | Use the release guide's pre-release checklist and linked evidence lanes; keep lane-specific sample-app, visual, and package-root evidence details in [`doc/release.md`](doc/release.md) instead of expanding this README map |
