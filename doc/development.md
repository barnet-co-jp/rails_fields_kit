...
- docs, smoke-inventory, and CI workflow policy drift: runner membership, read-only workflow permissions, docs wording, and public JavaScript export documentation that should stay aligned without turning this guide, README, or `doc/public_api.md` into an exhaustive smoke inventory
