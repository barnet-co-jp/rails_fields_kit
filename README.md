...
| Choose a helper or migrate from `collection_select` | [`doc/field_helpers.md`](doc/field_helpers.md) | [`doc/select_migration.md`](doc/select_migration.md), [`doc/grouped_select.md`](doc/grouped_select.md), [`doc/enum_select.md`](doc/enum_select.md), [`doc/textarea_autosize.md`](doc/textarea_autosize.md), [`doc/range_field.md`](doc/range_field.md), [`doc/password_field.md`](doc/password_field.md), [`doc/native_numeric_fields.md`](doc/native_numeric_fields.md), and [`doc/native_contact_fields.md`](doc/native_contact_fields.md) for focused helper boundaries; use [`doc/mention_field_boundary.md`](doc/mention_field_boundary.md) only when comparing nearby current helpers with the future textarea mention proposal |
