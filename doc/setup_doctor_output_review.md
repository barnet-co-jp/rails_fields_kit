...
- Use the representative review states below to decide whether the PR evidence should cover the first-run legend, an advisory-only Tom Select package lane, a CSS import advisory lane, an importmap mismatch lane, or all of those states.
