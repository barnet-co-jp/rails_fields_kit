...
| Choose a helper or migrate from `collection_select` | [`doc/field_helpers.md`](doc/field_helpers.md) | [`doc/select_migration.md`](doc/select_migration.md), [`doc/grouped_select.md`](doc/grouped_select.md), [`doc/enum_select.md`](doc/enum_select.md), [`doc/textarea_autosize.md`](doc/textarea_autosize.md), [`doc/range_field.md`](doc/range_field.md), [`doc/password_field.md`](doc/password_field.md), [`doc/file_field.md`](doc/file_field.md), [`doc/native_numeric_fields.md`](doc/native_numeric_fields.md), and [`doc/native_contact_fields.md`](doc/native_contact_fields.md) for focused helper boundaries; use [`doc/masked_input_boundary.md`](doc/masked_input_boundary.md), [`doc/slug_helper_boundary.md`](doc/slug_helper_boundary.md), [`doc/datalist_boundary.md`](doc/datalist_boundary.md), or [`doc/mention_field_boundary.md`](doc/mention_field_boundary.md) only when comparing nearby current helpers with future proposal boundaries |
